...
import { addTempEmp } from '@app/store/reducers/services';


const AddEmp = ({close}:any) => {
    ...
    // wizard1 submission
    const addEmpTab1=async(fName:string,mName:string,lName:string,nationality:string,dob:string,gender:string,userMobileNo:string,email:string,maritalStatus:string)=>{
        try{
            const obj={fName,mName,lName,nationality,dob,gender,userMobileNo,email,maritalStatus};
            const response= await service.createNewEmp1(obj);

            if(response.statusCode==1){
                dispatch(addTempEmp(response.data));
                localStorage.setItem("tempEmp",response.data._id);
    ...
    onSubmit: (values)=>{
        if(!first){
            addEmpTab1(values.fName,values.mName,values.lName,values.nationality,values.dob,values.gender,values.userMobileNo,values.email,values.maritalStatus);           
                ...
                <Container>
                    <form onSubmit={formik1.handleSubmit} style={{position:"relative"}} onReset={formik1.handleReset}>
                        <div>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-md-4">
                                    ...
                                    <Form.Control type="text" id="mName" placeholder="Middle Name" onChange={formik1.handleChange} value={formik1.values.mName}/>
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    ...
                                    <div>
                                        <Form.Check type="radio" inline label='Male' name="gender" id="gender1" value="male" onChange={formik1.handleChange} defaultChecked={formik1.values.gender==="male"} />
                                        <Form.Check type="radio" inline label='Female' name="gender" id="gender2" value="female" onChange={formik1.handleChange} defaultChecked={formik1.values.gender==="female"}/>
                                        <Form.Check type="radio" inline label="Others" name="gender" id="gender3" value="others" onChange={formik1.handleChange} defaultChecked={formik1.values.gender==="others"}/>
                                        <Form.Control.Feedback type="invalid">
                        ...
                        <div className='mb-3 d-flex justify-content-end btn_container'>
                            {first && <button type='reset' className='btn btn-outline-primary addEmp-btn'>Cancel</button> }
                            <button className='btn btn-primary addEmp-btn' type='submit'>{first ? "Update":"Next"}</button>
                        </div>
                    </form>
                </Container>
            )
                    ...
                    <form onSubmit={formik2.handleSubmit}>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                                ...
                                <Select id='userRole' options={options} closeMenuOnSelect={false}  isMulti onChange={getRole} />
                                <Form.Control.Feedback type="invalid">
                        ...
                        <div className="row mb-3">
                            <div className="col-md-12">
                                ...
                                <div>
                                        <Form.Check type="radio" inline label='Active' name="gender_radio" value="1" id="active" onChange={formik1.handleChange} defaultChecked={formik2.values.empStatus===1}/>
                                        <Form.Check type="radio" inline label='Terminated' name="gender_radio" value="0" id="terminate" onChange={formik1.handleChange} defaultChecked={formik2.values.empStatus===0}/>
                                </div>
                                <Form.Control.Feedback type="invalid">
                        ...
                        <div className="row mb-3 d-flex justify-content-end">
                            ...
                            <button type="submit" className='btn btn-primary addEmp-btn'>Next</button>
                        </div>
                    </form>
                </Container>
            )
                    ...
                    <form onSubmit={formik3.handleSubmit}>
                        ...
                        <div className="border border-secondary rounded p-2 mb-3" style={{backgroundColor:"#212A3E",color:"#fff"}}>
                            <div className="row mb-2">
                                <div className="col-md-12">
                                    <label htmlFor="add1" className="form-label w-100">Permanent Address:</label>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-md-4">
                                    ...
                                    <Form.Control type="text" className="form-control" id="pin1" placeholder="Pin" value={formik3.values.pin1} onChange={formik3.handleChange} isValid={formik3.touched.pin1 && !formik3.errors.pin1} isInvalid={formik3.touched.pin1 && !!formik3.errors.pin1}/>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <label htmlFor="inputCountry1" className="form-label">Country:</label>
                                    <select id="country1" className="form-select" value={formik3.values.country1} onChange={formik3.handleChange}>
                                ...
                                <div className="col-md-6">
                                    <label htmlFor="state1" className="form-label">Satate:</label>
                                    <select id="state1" className="form-select" value={formik3.values.state1} onChange={formik3.handleChange}>
                                        <option defaultChecked>Select</option>
                        ...
                        <div className="border border-secondary rounded p-2 mb-3 bg-secondary" >
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <select id="state2" className="form-select" value={formik3.values.state2} onChange={formik3.handleChange}>
                                        <option defaultChecked>Select</option>
                                        <option>State1</option>
                                        <option>others</option>
                                    </select>
                        ...
                        <div className="row d-flex justify-content-end">
                            <button className='btn btn-primary addEmp-btn' type='submit'>Submit</button>
                        </div>
                    </form>
